...
search_input = wait.until { @driver.find_element(class: 'app-search__form') }
search_input.send_keys('testando poxaKKKKKKKKK')
# @driver.find_element(class: 'app-search__form').send_keys('testando poxaKKKKKKKKK')
