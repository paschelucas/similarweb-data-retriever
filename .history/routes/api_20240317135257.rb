...
input_element = @driver.find_element(class: 'app-search__input').send_keys('testando poxaKKKKKKKKK')
if input_element.displayed?
    input_element.send_keys('testando poxaKKKKKKKKK')
  else
    puts "O elemento não está visível."
  end
