...
puts @driver.find_elements(tag_name: 'input').to_json
@driver.find_elements(tag_name: 'input')[0].send_keys('testando poxa')
# @wait.until { @searchInput = @driver.find_element(class: 'app-search__input').displayed? }
