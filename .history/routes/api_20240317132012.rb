...
@wait.until { RemoteError@chrome://remote/content/shared/RemoteError.sys.mjs:8:8: Element <input class="app-search__input"> is not reachable by keyboard (Selenium::WebDriver::Error::ElementNotInteractableError)}


@searchInput.send_keys('testando poxa')
post '/salve_info' do
    request.body.rewind
