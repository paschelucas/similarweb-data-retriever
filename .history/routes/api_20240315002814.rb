...
post '/salve_info' do
    ...
    LIST_URL = "#{BASE_SIMILARWEB_URL}/website/#{encodedUrl}/#overview"
    page = Nokogiri::HTML(URI.open(LIST_URL, 'User-Agent' => 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36'))
